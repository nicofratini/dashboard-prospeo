...
ALTER TABLE "public"."team_plans" OWNER TO "postgres";


ALTER TABLE "public"."team_plans" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."team_plans_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."team_plans"
    ADD CONSTRAINT "unique_team_plan" UNIQUE ("team_id", "plan_id");
...
ALTER TABLE ONLY "public"."team_plans"
    ADD CONSTRAINT "team_plans_plan_id_fkey" FOREIGN KEY ("plan_id") REFERENCES "public"."plans"("id");
...
GRANT ALL ON TABLE "public"."team_plans" TO "anon";
GRANT ALL ON TABLE "public"."team_plans" TO "authenticated";
GRANT ALL ON TABLE "public"."team_plans" TO "service_role";

GRANT ALL ON SEQUENCE "public"."team_plans_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."team_plans_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."team_plans_id_seq" TO "service_role";
